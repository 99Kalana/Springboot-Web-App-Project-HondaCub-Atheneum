...
import org.example.hondasupercub.repo.SellerProfileRepository;
...
public class SellerProfileServiceImpl implements SellerProfileService {
    ...
    @Autowired
    public SellerProfileServiceImpl(SellerProfileRepository sellerProfileRepository, ModelMapper modelMapper, BCryptPasswordEncoder passwordEncoder, JwtUtil jwtUtil) {
    ...
    public int updateUserProfile(UserDTO userDTO) {
        Optional<User> optionalUser = sellerProfileRepository.findById(userDTO.getUserId());
        ...
        sellerProfileRepository.save(user);
    ...
    public UserDTO getUserProfile(Integer userId) {
        Optional<User> optionalUser = sellerProfileRepository.findById(userId);
