...
public class AdminUserController {
    ...
    public ResponseEntity<InputStreamResource> generateUserReport() throws DocumentException, IOException {
        ByteArrayInputStream pdfReport = userService.generateUserPdfReport();
